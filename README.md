...
**📚 배운 점**
- ✅ 딥러닝 모델 성능뿐 아니라 **서비스 환경에 맞는 모델 선택의 중요성**
- ✅ 실시간 처리 요구사항이 있는 경우 **웹 환경의 한계와 대안 구조 이해**
- ✅ 단순 탐지를 넘어 **의사결정에 활용 가능한 AI 시스템 설계 경험**
- ✅ AI 기술을 실제 사회 문제(야생동물 출몰)에 적용하는 관점 확장
...
**📚 배운 점**
- 자연어 입력을 **정형 데이터(JSON)**로 변환하는 설계의 중요성
- 음성·텍스트가 결합된 환경에서 **동시성·에러 처리의 필요성**
- AI 기능 구현을 넘어 **실제 사용자를 고려한 UX 중심 설계 경험**
- LLM·STT·TTS를 하나의 서비스로 통합하는 **End-to-End AI 시스템 구축 경험**
